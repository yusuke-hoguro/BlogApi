...
export default function PostDetail(){
    ...
    // 各ボタンのスタイルを設定
    const btnEdit = "inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 hover:border-gray-400 transition focus:outline-none focus:ring-2 focus:ring-blue-500/40";
    const btnDelete = "inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-600 shadow-sm hover:border-red-400 hover:text-red-600 transition focus:outline-none focus:ring-2 focus:ring-red-500/30";
    const btnSave ="inline-flex items-center justify-center rounded-lg bg-blue-600 px-3 py-1.5 text-sm font-medium text-white shadow-sm hover:bg-blue-700 transition focus:outline-none focus:ring-2 focus:ring-blue-500/40";
    const btnCancel = "inline-flex items-center justify-center rounded-lg bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-200 transition focus:outline-none focus:ring-2 focus:ring-gray-500/30";
                        ...
                        {!comments || comments.length === 0 ? (
                            ...
                            <ul className='space-y-4'>
                                {comments.map(comment => (
                                    // コメントカード全体
                                    <li key={comment.id} data-testid="comment-item" className='border border-gray-200 rounded-lg shadow-sm bg-white p-4 max-w-full mx-auto min-w-0 overflow-x-hidden break-words'>
                                        {/* 編集モードか表示モードかを切り替え */}
